                                      ...
                                      void *param, const int64_t &startPts)
{
    ...
    m_image = QImage(QString("%1/logo.png").arg(AppConfig::AppDataPath_Data));
    ...
    while(!mIsStop)
    {
...

        {
            ...
            //fprintf(stderr, "mCurrentTime %d... \n", mCurrentTime);
            {
                ...
                if(AppConfig::gLogoImage.isNull() == false && AppConfig::gLogoDir != -1)
                {
                    QImage logoImage = AppConfig::gLogoImage.rgbSwapped();
                    logoImage = logoImage.mirrored(false, true);
                    QImage image = QImage(Data,width,
                    ...
                    case 0:
                        painter.drawImage(0,height - logoImage.height(),logoImage);
                        break;
                    case 1:
                        painter.drawImage(0,0,logoImage);
                        break;
                    case 2:
                        painter.drawImage((width - logoImage.width()) / 2,(height - logoImage.height()) / 2,logoImage);
                        break;
                    case 3: //> 右上
                        painter.drawImage(width - logoImage.width(),height - logoImage.height(),logoImage);
                        break;
                    case 4: //> 右下
                        painter.drawImage(width - logoImage.width(),0,logoImage);
                        break;
                    default:
                        break;
                    }

                    memcpy(outBufferRGB, image.constBits(), width*height*3);
